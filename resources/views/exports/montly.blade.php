<table>
    <thead style="text-align: center;">
        <tr>
            <td rowspan="2" colspan="{{iterator_count($periods)+10}}"><h1> <font face="hind siliguri" size="6"> তুষার’স কেয়ার </font>  <br>   <font face="hind siliguri" size="5"> একাডেমিক এন্ড এডমিশন  </font></h1></td>
        </tr>
        <tr></tr>
        <tr>
            <th>#</th>
